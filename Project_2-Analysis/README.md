...
## Table of Contents
- [Do more skills result in more pay?](#how-to-create-your-profile)
- [What is the salary for data jobs in different regions?](#how-to-customize-markdown-files)
- [What are the top skills of data professionals?](#how-to-create-new-repository)
- [What is the pay for the top 10 skills?](#how-to-create-new-repository)
